...
@interface LPScanView ()<AVCaptureMetadataOutputObjectsDelegate,CAAnimationDelegate>
{
...
- (void)addAnimation{
    ...
    line.hidden = NO;
    CABasicAnimation *animation = [LPScanView moveYTime:2 fromY:[NSNumber numberWithFloat:4] toY:[NSNumber numberWithFloat:self.scanW -2] rep:OPEN_MAX];
